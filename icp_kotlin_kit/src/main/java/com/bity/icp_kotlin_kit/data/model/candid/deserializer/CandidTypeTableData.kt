        ...
        fun decode(source: BufferedSource): CandidTypeTableData {
            ...
            return when (primitive) {
                ...
                CandidPrimitiveType.FUNCTION -> {
                    val nInputs: Int = LEB128.decodeUnsigned(source)
                    val inputTypes = (0 until nInputs).map {
                        LEB128.decodeSigned(source)
                    }

                    val nOutputs: Int = LEB128.decodeUnsigned(source)
                    val outputTypes = (0 until nOutputs).map {
                        LEB128.decodeSigned(source)
                    }

                    val nAnnotations: Int = LEB128.decodeUnsigned(source)
