package com.bity.icp_kotlin_kit.data.model.candid.serializer
...
internal sealed class CandidEncodableValue {
    ...
    fun encodeType(): ByteArray {
        return when (this) {
            is Null -> LEB128.encodeSigned(CandidPrimitiveType.NULL.value)
            is Blob -> LEB128.encodeSigned(typeRef)
            is Bool -> LEB128.encodeSigned(CandidPrimitiveType.BOOL.value)
            Empty -> LEB128.encodeSigned(CandidPrimitiveType.EMPTY.value)
            is Float32 -> LEB128.encodeSigned(CandidPrimitiveType.FLOAT32.value)
            is Float64 -> LEB128.encodeSigned(CandidPrimitiveType.FLOAT64.value)
            is Function -> LEB128.encodeSigned(typeRef)
            is Integer -> LEB128.encodeSigned(CandidPrimitiveType.INTEGER.value)
            is Integer16 -> LEB128.encodeSigned(CandidPrimitiveType.INTEGER16.value)
            is Integer32 -> LEB128.encodeSigned(CandidPrimitiveType.INTEGER32.value)
            is Integer64 -> LEB128.encodeSigned(CandidPrimitiveType.INTEGER64.value)
            is Integer8 -> LEB128.encodeSigned(CandidPrimitiveType.INTEGER8.value)
            is Natural -> LEB128.encodeSigned(CandidPrimitiveType.NATURAL.value)
            is Natural16 -> LEB128.encodeSigned(CandidPrimitiveType.NATURAL16.value)
            is Natural32 -> LEB128.encodeSigned(CandidPrimitiveType.NATURAL32.value)
            is Natural64 -> LEB128.encodeSigned(CandidPrimitiveType.NATURAL64.value)
            is Natural8 -> LEB128.encodeSigned(CandidPrimitiveType.NATURAL8.value)
            is Option -> LEB128.encodeSigned(typeRef)
            is Record -> LEB128.encodeSigned(typeRef)
            Reserved -> LEB128.encodeSigned(CandidPrimitiveType.RESERVED.value)
            is Service -> LEB128.encodeSigned(typeRef)
            is Text -> LEB128.encodeSigned(CandidPrimitiveType.TEXT.value)
            is Variant -> LEB128.encodeSigned(typeRef)
            is Vector -> LEB128.encodeSigned(typeRef)
            is Principal -> LEB128.encodeSigned(typeRef)
        }
    }
